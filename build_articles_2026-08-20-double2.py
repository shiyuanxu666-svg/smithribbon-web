"""Generate two NEW B2B articles for 2026-08-20 second push (am 70 + pm 71) — Smith Ribbon blog."""
import os
...
ARTICLES = [
    {
        "slot": "am",
        "num": 70,
        "module_label": "70-Module",
        "topic_tag": "Mill-Side Predictive-Quality AI-Vision Inline-Defect-Detection Closed-Loop Manufacturing Architecture",
        "topic": "Mill-Side Predictive-Quality AI-Vision Inline-Defect-Detection Closed-Loop Manufacturing",
        ...
        "short_title": "Ribbon OEM 70-Module Mill-Side Predictive-Quality AI-Vision Inline-Defect-Detection Closed-Loop Manufacturing Architecture 2026",
        "cat": "Mill-Side Predictive-Quality AI-Vision Inline-Defect-Detection Closed-Loop Manufacturing",
        ...
        "kw": "ribbon OEM AI vision, ribbon OEM inline defect, ribbon OEM predictive quality, ribbon OEM closed loop, ribbon OEM edge inference, ribbon OEM spectro, ribbon OEM CAPA, ribbon OEM 2026 brand procurement, ribbon OEM industry 4.0, ribbon OEM 2026",
        "slug_date": "2026-08-20-am2",
        "meters": "6.4M",
        "brands": 57,
        "eu": 21,
        "na": 27,
        ...
        "modules": 70,
        "layers": 6,
        "m1": "9-AI-Vision-Cadre, 8-Defect-Library, 7-Inference-Edge, 6-Closed-Loop-Feedback, 5-Line-Side-Spectro",
        "m2": "8-Defect-CAPA, 6-Yield-Dashboard, 4-Vision-IP, 4-Vision-Cost &amp; 5-Vision-Continuous-Improvement",
    },
    {
        "slot": "pm",
        "num": 71,
        "module_label": "71-Module",
        "topic_tag": "Cross-Border-Logistics 3PL Multi-Market Warehouse Bonded FTZ DDP-Landed-Cost Orchestration Architecture",
        "topic": "Cross-Border-Logistics 3PL Multi-Market Warehouse Bonded FTZ DDP-Landed-Cost Orchestration",
        ...
        "short_title": "Ribbon OEM 71-Module Cross-Border-Logistics 3PL Multi-Market Warehouse Bonded FTZ DDP-Landed-Cost Orchestration Architecture 2026",
        "cat": "Cross-Border-Logistics 3PL Multi-Market Warehouse Bonded FTZ DDP-Landed-Cost Orchestration",
        ...
        "kw": "ribbon OEM 3PL, ribbon OEM bonded FTZ, ribbon OEM DDP, ribbon OEM landed cost, ribbon OEM customs classification, ribbon OEM multi market warehouse, ribbon OEM cross border, ribbon OEM 2026 brand procurement, ribbon OEM logistics, ribbon OEM 2026",
        "slug_date": "2026-08-20-pm2",
        "meters": "6.6M",
        "brands": 58,
        "eu": 22,
        "na": 27,
        ...
        "modules": 71,
        "layers": 6,
        "m1": "9-3PL-Cadre, 8-Bonded-FTZ, 7-Multi-Market-Warehouse, 6-DDP-Landed-Cost, 5-Customs-Classification",
        "m2": "8-Orchestration-Engine, 6-Track-Trace, 4-Logistics-IP, 4-Logistics-Cost &amp; 5-Logistics-Continuous-Improvement",
    },
]
...
SLUGS = {
    70: "mill-side-predictive-quality-ai-vision-inline-defect-detection-closed-loop-manufacturing",
    71: "cross-border-logistics-3pl-multi-market-warehouse-bonded-ftz-ddp-landed-cost-orchestration",
}
...
def build():
    for a in ARTICLES:
        ...
        num_low = str(n)
        if a["slot"] == "am":
            iso = "2026-08-20T11:00:00+08:00"
            date_label = "August 20, 2026 (AM Push #2)"
        else:
            iso = "2026-08-20T15:00:00+08:00"
            date_label = "August 20, 2026 (PM Push #2)"
