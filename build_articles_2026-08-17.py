"""Generate two B2B articles for 2026-08-17 (am + pm) — Smith Ribbon blog."""
import os, re
...
ARTICLES = [
    {
        "slot": "am",
        "num": 56,
        "module_label": "56-Module",
        "topic_tag": "Spec-Sheet &amp; Tech-Pack Translation-Decoder Architecture",
        "title": "Ribbon OEM 56-Module Spec-Sheet &amp; Tech-Pack Cross-Functional Translation-Decoder Architecture 2026",
        "short_title": "Ribbon OEM 56-Module Spec-Sheet &amp; Tech-Pack Translation-Decoder Architecture 2026",
        "cat": "Spec-Sheet &amp; Tech-Pack Translation-Decoder Architecture",
        ...
        "kw": "ribbon OEM spec sheet, ribbon OEM tech pack, ribbon OEM translation, ribbon OEM bilingual, ribbon OEM spec decode, ribbon OEM 2026 brand procurement, ribbon OEM spec sheet brand, ribbon OEM tech pack handoff, ribbon OEM tolerance translation, ribbon OEM color callout, ribbon OEM cross functional, ribbon OEM 2026",
        "slug_date": "2026-08-17-am",
        "meters": "4.1M",
        "brands": 46,
        "eu": 15,
        "na": 23,
        ...
        "modules": 56,
        "layers": 6,
        "m1": "9-Spec-Ingest, 8-Bilingual-Translate, 7-Color-Callout-Convert, 6-Tolerance-Translate, 5-Mill-Instruction-Handoff",
        "m2": "7-Cross-Functional-Loop, 6-Document-Archive, 4-Spec-IP, 4-Spec-Cost &amp; 4-Spec-Continuous-Improvement",
        "metric1": "92-98% 90-day-time-to-RFQ-response",
        "metric2": "72-88% spec-decode-accuracy",
        "metric3": "44-58% spec-roundtrip-cost-savings",
        "metric4": "18-26% RFQ-conversion-uplift",
        "metric5": "26-38% brand-trust-uplift",
    },
    {
        "slot": "pm",
        "num": 57,
        "module_label": "57-Module",
        "topic_tag": "Cross-Category Adjacent-Material Sourcing &amp; Bundle-Program Architecture",
        "title": "Ribbon OEM 57-Module Cross-Category Adjacent-Material Sourcing &amp; Bundle-Program Architecture 2026",
        "short_title": "Ribbon OEM 57-Module Adjacent-Material Sourcing &amp; Bundle-Program Architecture 2026",
        "cat": "Cross-Category Adjacent-Material Sourcing &amp; Bundle-Program Architecture",
        "desc": "A 2026 B2B ribbon OEM 57-module cross-category adjacent-material sourcing and bundle-program architecture for global brand owners, gifting-program-directors, seasonal-merchandising-managers, and private-label program directors. Covers adjacent-tissue, tag-stock, box, jar, pouch, and twine bundle-engineering, multi-SKU consolidation, cross-category cost-arbitrage, and 90-day time-to-bundle-shelf.",
        "kw": "ribbon OEM bundle program, ribbon OEM adjacent material, ribbon OEM cross category, ribbon OEM tissue, ribbon OEM hangtag, ribbon OEM gift box, ribbon OEM twine, ribbon OEM 2026 brand procurement, ribbon OEM bundle shelf, ribbon OEM multi SKU, ribbon OEM cross category 2026, ribbon OEM",
        "slug_date": "2026-08-17-pm",
        "meters": "4.4M",
        "brands": 48,
        "eu": 15,
        "na": 24,
        ...
        "modules": 57,
        "layers": 6,
        "m1": "8-Adjacent-Source, 9-Bundle-Engineer, 7-Multi-SKU-Consolidate, 6-Cross-Category-Cost-Arbitrage, 5-Bundle-Shelf-Handoff",
        "m2": "8-Compliance, 6-Bundle-Logistics, 4-Bundle-IP, 4-Bundle-Cost &amp; 5-Bundle-Continuous-Improvement",
        "metric1": "92-98% 90-day-time-to-bundle-shelf",
        "metric2": "78-92% bundle-cost-savings",
        "metric3": "44-58% cross-category-margin-uplift",
        "metric4": "18-26% bundle-conversion-uplift",
        "metric5": "26-38% brand-trust-uplift",
    },
]
...
SLUGS = {
    56: "spec-sheet-techpack-translation-decoder",
    57: "adjacent-material-bundle-program",
}

def kw_to_plain(kw):
    # strip html entities for JSON-LD
    return kw.replace("&amp;", "&")
...
def build():
    for a in ARTICLES:
        ...
        slug = SLUGS[n]
        num_low = str(n)
        # ISO time: 10:00 +08 for am, 15:00 +08 for pm
        if a["slot"] == "am":
            iso = "2026-08-17T10:00:00+08:00"
            date_label = "August 17, 2026"
        else:
            iso = "2026-08-17T15:00:00+08:00"
            date_label = "August 17, 2026"
        ...
        # fix double-braces from .format escape
