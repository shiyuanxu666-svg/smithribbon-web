"""Generate 2 B2B articles for smithribbon-web — 2026-08-30 cron DOUBLE 2 (modules 100 + 101).

AM article (100): Brand-Buyer Holiday-Peak Reverse-Logistics Returns-Recovery Clearance Architecture
PM article (101): Brand-Buyer Mill-Side Carbon-Water Scope-3 Decarbonization ESG-Disclosure Architecture
"""
import os
...
ARTICLES = [
    {
        "slot": "am",
        "num": 100,
        "slug": "brand-buyer-holiday-peak-reverse-logistics-returns-recovery-clearance-restock-grade-architecture",
        "module_label": "100-Module",
        "topic_tag": "Brand-Buyer Holiday-Peak Reverse-Logistics Returns-Recovery Clearance Restock-Grade Architecture",
        "topic": "Brand-Buyer Holiday-Peak Reverse-Logistics Returns-Recovery Clearance Restock-Grade Architecture",
        ...
        "short_title": "Ribbon OEM 100-Module Brand-Buyer Holiday-Peak Reverse-Logistics Returns-Recovery Clearance Restock-Grade Architecture 2026",
        "cat": "Brand-Buyer Holiday-Peak Reverse-Logistics Returns-Recovery Clearance Restock-Grade Architecture",
        ...
        "kw": "ribbon OEM reverse logistics, ribbon OEM returns recovery, ribbon OEM holiday clearance, ribbon OEM restock grade, ribbon OEM post peak, ribbon OEM 12 reverse cadre, ribbon OEM 11 recovery, ribbon OEM 10 clearance, ribbon OEM 9 restock, ribbon OEM 8 returns, ribbon OEM 2026 brand procurement, ribbon OEM 2026",
        "slug_date": "2026-08-30-am2",
        "meters": "11.4M",
        "brands": 85,
        "eu": 46,
        "na": 51,
        ...
        "modules": 100,
        "layers": 6,
        "m1": "12-Reverse-Logistics-Cadre, 11-Returns-Recovery-Engine, 10-Clearance-Restock-Pipeline, 9-Restock-Grade-Stack, 8-Returns-Archive",
        "m2": "7-Reverse-Dashboard, 9-Returns-IP, 6-Returns-Cost &amp; 10-Returns-Continuous-Improvement",
    },
    {
        "slot": "pm",
        "num": 101,
        "slug": "brand-buyer-mill-side-carbon-water-scope-3-decarbonization-esg-disclosure-architecture",
        "module_label": "101-Module",
        "topic_tag": "Brand-Buyer Mill-Side Carbon-Water Scope-3 Decarbonization ESG-Disclosure Architecture",
        "topic": "Brand-Buyer Mill-Side Carbon-Water Scope-3 Decarbonization ESG-Disclosure Architecture",
        "title": "Ribbon OEM 101-Module Brand-Buyer Mill-Side Carbon-Water Scope-3 Decarbonization ESG-Disclosure Architecture 2026",
        "short_title": "Ribbon OEM 101-Module Brand-Buyer Mill-Side Carbon-Water Scope-3 Decarbonization ESG-Disclosure Architecture 2026",
        "cat": "Brand-Buyer Mill-Side Carbon-Water Scope-3 Decarbonization ESG-Disclosure Architecture",
        ...
        "kw": "ribbon OEM scope 3, ribbon OEM carbon water, ribbon OEM decarbonization, ribbon OEM ESG disclosure, ribbon OEM CSRD, ribbon OEM 12 decarbonization cadre, ribbon OEM 11 scope 3, ribbon OEM 10 disclosure, ribbon OEM 9 carbon water, ribbon OEM 8 CSRD, ribbon OEM 2026 brand procurement, ribbon OEM 2026",
        "slug_date": "2026-08-30-pm2",
        "meters": "11.6M",
        "brands": 86,
        "eu": 47,
        "na": 52,
        ...
        "modules": 101,
        "layers": 6,
        "m1": "12-Decarbonization-Cadre, 11-Scope-3-Engine, 10-ESG-Disclosure-Pipeline, 9-Carbon-Water-Stack, 8-CSRD-Archive",
        "m2": "7-ESG-Dashboard, 9-ESG-IP, 6-ESG-Cost &amp; 10-ESG-Continuous-Improvement",
    },
]
...
def build():
    ...
    for a in ARTICLES:
        ...
        iso = "2026-08-30T12:00:00+08:00"
        if a["slot"] == "am":
            iso_date_human = "August 30, 2026 — 10:00 AM CST"
        else:
            iso_date_human = "August 30, 2026 — 3:00 PM CST"
