"""Generate two NEW B2B articles for 2026-08-22 (am 74 + pm 75) — Smith Ribbon blog."""
import os
...
ARTICLES = [
    {
        "slot": "am",
        "num": 76,
        "module_label": "76-Module",
        "topic_tag": "Mill-Side AI-Vision Defect-Detection Real-Time Inline-Quality Edge-AI Closed-Loop Architecture",
        "topic": "Mill-Side AI-Vision Defect-Detection Real-Time Inline-Quality Edge-AI Closed-Loop",
        ...
        "short_title": "Ribbon OEM 76-Module Mill-Side AI-Vision Defect-Detection Real-Time Inline-Quality Edge-AI Closed-Loop Architecture 2026",
        "cat": "Mill-Side AI-Vision Defect-Detection Real-Time Inline-Quality Edge-AI Closed-Loop",
        "desc": "A 2026 B2B ribbon OEM 74-module mill-side AI-vision defect-detection real-time inline-quality edge-AI closed-loop architecture for global brand owners, QA-directors, quality-VPs, and pre-shipment-inspection leads. Covers 9-edge-AI-cadre, 8-vision-defect-pipeline, 7-inline-quality-engine, 6-defect-library, 5-real-time-CAPA, 8-defect-archive, 6-AI-vision-dashboard, 4-vision-IP, 4-vision-cost &amp; 5-vision-continuous-improvement modules. Delivers 92-98% 21-day-time-to-vision-pilot-launch, 84-94% defect-detection-accuracy, 44-58% AQL-fail-reduction, 18-26% cost-of-quality-savings, 61 brand partners, 25 EU-27 markets, 30 NA-states, 31 MEA-jurisdictions, 2,100 active SKUs on a 7.2M-meter annual multi-brand multi-jurisdiction AI-vision inline-quality closed-loop program.",
        "kw": "ribbon OEM AI vision, ribbon OEM defect detection, ribbon OEM inline quality, ribbon OEM edge AI, ribbon OEM real time CAPA, ribbon OEM AQL, ribbon OEM 2026 brand procurement, ribbon OEM 2026",
        "slug_date": "2026-08-22-am",
        "meters": "7.2M",
        "brands": 61,
        "eu": 25,
        "na": 30,
        ...
        "modules": 76,
        "layers": 6,
        "m1": "9-Edge-AI-Cadre, 8-Vision-Defect-Pipeline, 7-Inline-Quality-Engine, 6-Defect-Library, 5-Real-Time-CAPA",
        "m2": "8-Defect-Archive, 6-AI-Vision-Dashboard, 4-Vision-IP, 4-Vision-Cost &amp; 5-Vision-Continuous-Improvement",
    },
    {
        "slot": "pm",
        "num": 77,
        "module_label": "77-Module",
        "topic_tag": "Brand-Buyer Holiday-Seasonality Repeat-Order 90-Day Calendar Cascade-Production Demand-Sensing Architecture",
        "topic": "Brand-Buyer Holiday-Seasonality Repeat-Order 90-Day Calendar Cascade-Production Demand-Sensing",
        ...
        "modules": 77,
        "layers": 6,
        "m1": "9-Cascade-Cadre, 8-90-Day-Calendar-Pipeline, 7-Repeat-Order-Engine, 6-Demand-Sensing, 5-Seasonal-Forecast",
        "m2": "8-Cascade-Capacity, 6-Seasonality-Dashboard, 4-Cascade-IP, 4-Cascade-Cost &amp; 5-Cascade-Continuous-Improvement",
    },
]
...
SLUGS = {
    76: "mill-side-ai-vision-defect-detection-real-time-inline-quality-edge-ai-closed-loop",
    77: "brand-buyer-holiday-seasonality-repeat-order-90-day-calendar-cascade-production-demand-sensing",
}
...
def build():
    for a in ARTICLES:
        ...
        num_low = str(n)
        if a["slot"] == "am":
            iso = "2026-08-22T10:00:00+08:00"
            date_label = "August 22, 2026 (AM Push)"
        else:
            iso = "2026-08-22T15:00:00+08:00"
            date_label = "August 22, 2026 (PM Push)"
