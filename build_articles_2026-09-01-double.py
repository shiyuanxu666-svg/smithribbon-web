"""Generate 2 B2B articles for smithribbon-web — 2026-09-01 cron DOUBLE (modules 107 + 108).

AM article (107): Brand-Buyer Mill-Side Circular-Economy Closed-Loop Take-Back Reuse Recycling Refurbishment Architecture
PM article (108): Brand-Buyer Multi-Market Cross-Border DDP Landed-Cost Customs-Broker Duty-Vat Optimization Architecture
"""
import os
...
ARTICLES = [
    {
        "slot": "am",
        "num": 107,
        "slug": "brand-buyer-mill-side-circular-economy-closed-loop-take-back-reuse-recycling-refurbishment-architecture",
        "module_label": "107-Module",
        "topic_tag": "Brand-Buyer Mill-Side Circular-Economy Closed-Loop Take-Back Reuse Recycling Refurbishment Architecture",
        "topic": "Brand-Buyer Mill-Side Circular-Economy Closed-Loop Take-Back Reuse Recycling Refurbishment Architecture",
        ...
        "short_title": "Ribbon OEM 107-Module Brand-Buyer Mill-Side Circular-Economy Closed-Loop Take-Back Reuse Recycling Refurbishment Architecture 2026",
        "cat": "Brand-Buyer Mill-Side Circular-Economy Closed-Loop Take-Back Reuse Recycling Refurbishment Architecture",
        ...
        "kw": "ribbon OEM circular economy, ribbon OEM take back, ribbon OEM closed loop, ribbon OEM post consumer, ribbon OEM refurbishment, ribbon OEM 12 circular cadre, ribbon OEM 11 take back engine, ribbon OEM 10 reuse pipeline, ribbon OEM 9 recycle stack, ribbon OEM 8 refurb, ribbon OEM 2026 brand procurement, ribbon OEM 2026",
        "slug_date": "2026-09-01-am",
        "meters": "12.2M",
        "brands": 89,
        "eu": 50,
        "na": 55,
        ...
        "modules": 107,
        "layers": 6,
        "m1": "12-Circular-Cadre, 11-Take-Back-Engine, 10-Reuse-Pipeline, 9-Recycle-Stack, 8-Refurb-Archive",
        "m2": "7-Circular-Dashboard, 9-Take-Back-IP, 6-Circular-Cost &amp; 10-Circular-Continuous-Improvement",
    },
    {
        "slot": "pm",
        "num": 108,
        "slug": "brand-buyer-multi-market-cross-border-ddp-landed-cost-customs-broker-duty-vat-optimization-architecture",
        "module_label": "108-Module",
        "topic_tag": "Brand-Buyer Multi-Market Cross-Border DDP Landed-Cost Customs-Broker Duty-Vat Optimization Architecture",
        "topic": "Brand-Buyer Multi-Market Cross-Border DDP Landed-Cost Customs-Broker Duty-Vat Optimization Architecture",
        ...
        "short_title": "Ribbon OEM 108-Module Brand-Buyer Multi-Market Cross-Border DDP Landed-Cost Customs-Broker Duty-Vat Optimization Architecture 2026",
        "cat": "Brand-Buyer Multi-Market Cross-Border DDP Landed-Cost Customs-Broker Duty-Vat Optimization Architecture",
        ...
        "kw": "ribbon OEM DDP landed cost, ribbon OEM customs broker, ribbon OEM duty VAT, ribbon OEM cross border, ribbon OEM landed cost optimization, ribbon OEM 12 DDP cadre, ribbon OEM 11 customs broker, ribbon OEM 10 duty VAT, ribbon OEM 9 landed cost, ribbon OEM 8 DDP, ribbon OEM 2026 brand procurement, ribbon OEM 2026",
        "slug_date": "2026-09-01-pm",
        "meters": "12.4M",
        "brands": 90,
        "eu": 51,
        "na": 56,
        ...
        "modules": 108,
        "layers": 6,
        "m1": "12-DDP-Cadre, 11-Customs-Broker-Engine, 10-Duty-VAT-Pipeline, 9-Landed-Cost-Stack, 8-DDP-Archive",
        "m2": "7-Landed-Cost-Dashboard, 9-DDP-IP, 6-DDP-Cost &amp; 10-DDP-Continuous-Improvement",
    },
]
...
def build():
    ...
    for a in ARTICLES:
        ...
        if a["slot"] == "am":
            iso = "2026-09-01T10:00:00+08:00"
            iso_date_human = "September 1, 2026 — 10:00 AM CST"
        else:
            iso = "2026-09-01T15:00:00+08:00"
            iso_date_human = "September 1, 2026 — 3:00 PM CST"
