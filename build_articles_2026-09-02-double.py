"""Generate 2 B2B articles for smithribbon-web — 2026-09-02 cron DOUBLE (modules 109 + 110).

AM article (109): Brand-Buyer Mill-Side Recycled-PET GRS Closed-Loop rPET-Recycled-Polyester-Acrylic-Fiber-Yarn Traceability Mill-to-Shelf Architecture
PM article (110): Brand-Buyer Multi-Tier Sub-Tier Subcontracting 4-Tier Mapping Risk-Resilience Supplier-Diversification Transparency Architecture
"""
import os
...
ARTICLES = [
    {
        "slot": "am",
        "num": 109,
        "slug": "brand-buyer-mill-side-recycled-pet-grs-closed-loop-rpet-recycled-polyester-acrylic-fiber-yarn-traceability-mill-to-shelf-architecture",
        "module_label": "109-Module",
        "topic_tag": "Brand-Buyer Mill-Side Recycled-PET GRS Closed-Loop rPET-Recycled-Polyester-Acrylic-Fiber-Yarn Traceability Mill-to-Shelf Architecture",
        "topic": "Brand-Buyer Mill-Side Recycled-PET GRS Closed-Loop rPET-Recycled-Polyester-Acrylic-Fiber-Yarn Traceability Mill-to-Shelf Architecture",
        ...
        "short_title": "Ribbon OEM 109-Module Brand-Buyer Mill-Side Recycled-PET GRS Closed-Loop rPET-Recycled-Polyester-Acrylic-Fiber-Yarn Traceability Mill-to-Shelf Architecture 2026",
        "cat": "Brand-Buyer Mill-Side Recycled-PET GRS Closed-Loop rPET-Recycled-Polyester-Acrylic-Fiber-Yarn Traceability Mill-to-Shelf Architecture",
        ...
        "kw": "ribbon OEM recycled PET, ribbon OEM GRS certification, ribbon OEM rPET, ribbon OEM closed loop, ribbon OEM acrylic fiber yarn, ribbon OEM 12 rPET cadre, ribbon OEM 11 GRS engine, ribbon OEM 10 acrylic fiber, ribbon OEM 9 traceability, ribbon OEM 8 mill to shelf, ribbon OEM 2026 brand procurement, ribbon OEM 2026",
        "slug_date": "2026-09-02-am",
        "meters": "12.0M",
        "brands": 88,
        "eu": 49,
        "na": 54,
        ...
        "modules": 109,
        "layers": 6,
        "m1": "12-rPET-Cadre, 11-GRS-Engine, 10-Acrylic-Fiber-Pipeline, 9-Traceability-Stack, 8-Mill-to-Shelf-Archive",
        "m2": "7-rPET-Dashboard, 9-Closed-Loop-IP, 6-rPET-Cost &amp; 10-rPET-Continuous-Improvement",
    },
    {
        "slot": "pm",
        "num": 110,
        "slug": "brand-buyer-multi-tier-sub-tier-subcontracting-4-tier-mapping-risk-resilience-supplier-diversification-transparency-architecture",
        "module_label": "110-Module",
        "topic_tag": "Brand-Buyer Multi-Tier Sub-Tier Subcontracting 4-Tier Mapping Risk-Resilience Supplier-Diversification Transparency Architecture",
        "topic": "Brand-Buyer Multi-Tier Sub-Tier Subcontracting 4-Tier Mapping Risk-Resilience Supplier-Diversification Transparency Architecture",
        ...
        "short_title": "Ribbon OEM 110-Module Brand-Buyer Multi-Tier Sub-Tier Subcontracting 4-Tier Mapping Risk-Resilience Supplier-Diversification Transparency Architecture 2026",
        "cat": "Brand-Buyer Multi-Tier Sub-Tier Subcontracting 4-Tier Mapping Risk-Resilience Supplier-Diversification Transparency Architecture",
        ...
        "kw": "ribbon OEM multi tier, ribbon OEM sub tier, ribbon OEM subcontracting, ribbon OEM 4 tier mapping, ribbon OEM risk resilience, ribbon OEM 12 tier cadre, ribbon OEM 11 sub tier, ribbon OEM 10 subcontracting, ribbon OEM 9 mapping, ribbon OEM 8 resilience, ribbon OEM 2026 brand procurement, ribbon OEM 2026",
        "slug_date": "2026-09-02-pm",
        "meters": "12.6M",
        "brands": 91,
        "eu": 52,
        "na": 57,
        ...
        "modules": 110,
        "layers": 6,
        "m1": "12-Tier-Cadre, 11-Sub-Tier-Engine, 10-Subcontracting-Pipeline, 9-Mapping-Stack, 8-Resilience-Archive",
        "m2": "7-Diversification-Dashboard, 9-Transparency-IP, 6-Resilience-Cost &amp; 10-Resilience-Continuous-Improvement",
    },
]
...
def build():
    ...
    for a in ARTICLES:
        ...
        if a["slot"] == "am":
            iso = "2026-09-02T10:00:00+08:00"
            iso_date_human = "September 2, 2026 — 10:00 AM CST"
        else:
            iso = "2026-09-02T15:00:00+08:00"
            iso_date_human = "September 2, 2026 — 3:00 PM CST"
