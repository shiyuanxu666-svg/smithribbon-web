"""Generate two NEW B2B articles for 2026-08-23 (am 79 + pm 80) — Smith Ribbon blog."""
import os
...
ARTICLES = [
    {
        "slot": "am",
        "num": 79,
        "module_label": "79-Module",
        "topic_tag": "Brand-Buyer Co-Branded Holiday-Cluster Cross-Region Gifting Bundle Reverse-Logistics Recovery Architecture",
        "topic": "Brand-Buyer Co-Branded Holiday-Cluster Cross-Region Gifting Bundle Reverse-Logistics Recovery",
        ...
        "short_title": "Ribbon OEM 79-Module Brand-Buyer Co-Branded Holiday-Cluster Cross-Region Gifting Bundle Reverse-Logistics Recovery Architecture 2026",
        "cat": "Brand-Buyer Co-Branded Holiday-Cluster Cross-Region Gifting Bundle Reverse-Logistics Recovery",
        ...
        "kw": "ribbon OEM co-branded holiday cluster, ribbon OEM cross region gifting bundle, ribbon OEM reverse logistics recovery, ribbon OEM holiday program, ribbon OEM co-branded bundle, ribbon OEM 2026 brand procurement, ribbon OEM 2026",
        "slug_date": "2026-08-23-am",
        "meters": "7.6M",
        "brands": 63,
        "eu": 27,
        "na": 32,
        ...
        "modules": 79,
        "layers": 6,
        "m1": "9-Cluster-Cadre, 8-Cross-Region-Pipeline, 7-Co-Branded-Bundle, 6-Gifting-Engine, 5-Recovery-CAPA",
        "m2": "8-Cluster-Archive, 6-Holiday-Dashboard, 4-Cluster-IP, 4-Cluster-Cost &amp; 5-Cluster-Continuous-Improvement",
    },
    {
        "slot": "pm",
        "num": 80,
        "module_label": "80-Module",
        "topic_tag": "Mill-Side Closed-Loop Take-Back Reuse Recycling Circular-Economy Brand-Trade-In Recovery Architecture",
        "topic": "Mill-Side Closed-Loop Take-Back Reuse Recycling Circular-Economy Brand-Trade-In Recovery",
        ...
        "short_title": "Ribbon OEM 80-Module Mill-Side Closed-Loop Take-Back Reuse Recycling Circular-Economy Brand-Trade-In Recovery Architecture 2026",
        "cat": "Mill-Side Closed-Loop Take-Back Reuse Recycling Circular-Economy Brand-Trade-In Recovery",
        ...
        "kw": "ribbon OEM circular economy, ribbon OEM take back, ribbon OEM reuse recycling, ribbon OEM brand trade in, ribbon OEM closed loop recovery, ribbon OEM 2026 brand procurement, ribbon OEM 2026",
        "slug_date": "2026-08-23-pm",
        "meters": "7.8M",
        "brands": 64,
        "eu": 28,
        "na": 33,
        ...
        "modules": 80,
        "layers": 6,
        "m1": "9-Circular-Cadre, 8-Take-Back-Pipeline, 7-Reuse-Engine, 6-Recycling-Line, 5-Trade-In-Recovery",
        "m2": "8-Circular-Archive, 6-Circular-Dashboard, 4-Circular-IP, 4-Circular-Cost &amp; 5-Circular-Continuous-Improvement",
    },
]
...
SLUGS = {
    79: "brand-buyer-co-branded-holiday-cluster-cross-region-gifting-bundle-reverse-logistics-recovery",
    80: "mill-side-closed-loop-take-back-reuse-recycling-circular-economy-brand-trade-in-recovery",
}
...
def build():
    for a in ARTICLES:
        ...
        num_low = str(n)
        if a["slot"] == "am":
            iso = "2026-08-23T10:00:00+08:00"
            date_label = "August 23, 2026 (AM Push)"
        else:
